...
label_topics(list(c("zidane", "figo", "kroos"), c("gas", "power", "wind")), model = "HuggingFaceH4/zephyr-7b-beta", token = )
```
...
```{r}
# label_topics
labels_topicmodels <- label_topics(topics_topicmodels, context = "Journal of Statistical Software", token = )
